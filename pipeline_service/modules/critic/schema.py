...
_ISSUE_KIND_ALIASES: dict[str, IssueKind] = {
    ...
    "wrong_pattern":      IssueKind.wrong_material,
    "wrong_finish":       IssueKind.wrong_material,
    "wrong_surface":      IssueKind.wrong_material,
    "missing_logo":       IssueKind.missing_part,
    "missing_text":       IssueKind.missing_part,
    "missing_pattern":    IssueKind.missing_part,
    "missing_texture":    IssueKind.missing_part,
